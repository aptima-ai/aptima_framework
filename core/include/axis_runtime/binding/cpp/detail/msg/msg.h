...
class msg_t {
 public:
  ...
  std::string get_name(error_t *err = nullptr) const {
    aptima_ASSERT(c_msg, "Should not happen.");

    if (c_msg == nullptr) {
      if (err != nullptr && err->get_c_error() != nullptr) {
        aptima_error_set(err->get_c_error(), aptima_ERRNO_GENERIC,
                      "Invalid TEN message.");
      }
      return "";
    }

    return aptima_msg_get_name(c_msg);
  }
  ...
  bool set_dest(const char *uri, const char *graph,
    ...
    return aptima_msg_clear_and_set_dest(
  ...
  bool is_property_exist(const char *path, error_t *err = nullptr) {
    aptima_ASSERT(c_msg, "Should not happen.");
    aptima_ASSERT(path && strlen(path), "path should not be empty.");
    ...
    return aptima_msg_is_property_exist(
  ...
  uint8_t get_property_uint8(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_uint8(c_value,
                               err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  uint16_t get_property_uint16(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_uint16(c_value,
                                err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  uint32_t get_property_uint32(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_uint32(c_value,
                                err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  uint64_t get_property_uint64(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_uint64(c_value,
                                err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  int8_t get_property_int8(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_int8(c_value,
                              err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  int16_t get_property_int16(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_int16(c_value,
                               err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  int32_t get_property_int32(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_int32(c_value,
                               err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  int64_t get_property_int64(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_int64(c_value,
                               err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  float get_property_float32(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_float32(c_value,
                                 err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  double get_property_float64(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_float64(c_value,
                                 err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  std::string get_property_string(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_peek_raw_str(
  ...
  void *get_property_ptr(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_ptr(c_value,
                             err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  bool get_property_bool(const char *path, error_t *err = nullptr) {
    ...
    return aptima_value_get_bool(c_value,
                              err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  ten::buf_t get_property_buf(const char *path, error_t *err = nullptr) {
    ...
    aptima_buf_t *c_buf = aptima_value_peek_buf(c_value);
    aptima_buf_init_with_copying_data(&result.buf, c_buf->data, c_buf->size);
  ...
  bool set_property(const char *path, const ten::buf_t &value,
    ...
    aptima_buf_t buf;
    aptima_buf_init_with_copying_data(&buf, value.data(), value.size());
  ...
  // Internal use only.
  aptima_shared_ptr_t *get_underlying_msg() const { return c_msg; }
 ...
 protected:
  ...
  // first.
  msg_t() = default;
  explicit msg_t(aptima_shared_ptr_t *msg) : c_msg(msg) {}
  // @}
   ...
   */
  bool set_property_impl(const char *path, aptima_value_t *value,
                         error_t *err = nullptr) {
    aptima_ASSERT(c_msg, "Should not happen.");

    bool rc = aptima_msg_set_property(
  ...
  void relinquish_underlying_msg() {
    if (c_msg != nullptr) {
      aptima_shared_ptr_destroy(c_msg);
      c_msg = nullptr;
    }
  }

  aptima_shared_ptr_t *c_msg = nullptr;  // NOLINT

 private:
  friend msg_internal_accessor_t;

  aptima_value_t *peek_property_value(const char *path, error_t *err) const {
    aptima_ASSERT(c_msg, "Should not happen.");

    return aptima_msg_peek_property(c_msg, path,
                                 err != nullptr ? err->get_c_error() : nullptr);
  }

  // Not sure if we should have this as a public API, so for now, let's keep it
  // private.
  aptima_MSG_TYPE get_type(error_t *err = nullptr) const {
    if (c_msg == nullptr) {
      if (err != nullptr && err->get_c_error() != nullptr) {
        aptima_error_set(err->get_c_error(), aptima_ERRNO_INVALID_ARGUMENT,
                      "Invalid TEN message.");
      }
      return aptima_MSG_TYPE_INVALID;
    }

    return aptima_msg_get_type(c_msg);
  }
};
