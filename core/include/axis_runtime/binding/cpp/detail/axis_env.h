...
using result_handler_func_t =
    std::function<void(axis_env_t &, std::unique_ptr<cmd_result_t>, error_t *)>;

using error_handler_func_t = std::function<void(axis_env_t &, error_t *)>;

class axis_env_t {
 public:
  // @{
  axis_env_t(const axis_env_t &) = delete;
  axis_env_t(axis_env_t &&) = delete;
  axis_env_t &operator=(const axis_env_t &) = delete;
  axis_env_t &operator=(const axis_env_t &&) = delete;
  // @}
  ...
  bool send_data(std::unique_ptr<data_t> &&data,
                 ...
                 error_t *err = nullptr) {
    axis_ASSERT(c_axis_env && data, "Should not happen.");
    ...
    if (error_handler == nullptr) {
      rc = axis_env_send_data(c_axis_env, data->get_underlying_msg(), nullptr,
                             nullptr,
      ...
      rc = axis_env_send_data(c_axis_env, data->get_underlying_msg(),
  ...
  bool send_video_frame(std::unique_ptr<video_frame_t> &&frame,
    ...
    if (error_handler == nullptr) {
      rc = axis_env_send_video_frame(
          c_axis_env, frame->get_underlying_msg(), nullptr, nullptr,
          err != nullptr ? err->get_c_error() : nullptr);
    } else {
      auto *error_handler_ptr =
          new error_handler_func_t(std::move(error_handler));
      ...
      rc = axis_env_send_video_frame(
          c_axis_env, frame->get_underlying_msg(), proxy_handle_error,
  ...
  bool return_result_directly(std::unique_ptr<cmd_result_t> &&cmd,
    ...
    if (error_handler == nullptr) {
      rc = axis_env_return_result_directly(
          c_axis_env, cmd->get_underlying_msg(), nullptr, nullptr,
          err != nullptr ? err->get_c_error() : nullptr);
    } else {
      auto *error_handler_ptr =
          new error_handler_func_t(std::move(error_handler));
      ...
      rc = axis_env_return_result_directly(
          c_axis_env, cmd->get_underlying_msg(), proxy_handle_return_error,
          error_handler_ptr, err != nullptr ? err->get_c_error() : nullptr);
      if (!rc) {
        delete error_handler_ptr;
      }
  ...
  bool return_result(std::unique_ptr<cmd_result_t> &&cmd,
    ...
    if (error_handler == nullptr) {
      rc = axis_env_return_result(c_axis_env, cmd->get_underlying_msg(),
  ...
  bool is_property_exist(const char *path, error_t *err = nullptr) {
    ...
    return axis_env_is_property_exist(
        c_axis_env, path, err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  bool init_property_from_json(const char *json_str, error_t *err = nullptr) {
    ...
    return axis_env_init_property_from_json(
        c_axis_env, json_str, err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  uint8_t get_property_uint8(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_uint8(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
      axis_error_copy(err->get_c_error(), cpp_err.get_c_error());
    }
  ...
  uint16_t get_property_uint16(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_uint16(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  uint32_t get_property_uint32(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_uint32(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  uint64_t get_property_uint64(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_uint64(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  int8_t get_property_int8(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_int8(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  int16_t get_property_int16(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_int16(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  int32_t get_property_int32(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_int32(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  int64_t get_property_int64(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_int64(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  float get_property_float32(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_float32(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  double get_property_float64(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_float64(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  std::string get_property_string(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    const auto *result = axis_value_peek_raw_str(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  void *get_property_ptr(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto *result = axis_value_get_ptr(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  bool get_property_bool(const char *path, error_t *err = nullptr) {
    ...
    error_t cpp_err;
    auto result = axis_value_get_bool(c_value, cpp_err.get_c_error());
    if (!cpp_err.is_success()) {
      axis_LOGW("Failed to get property %s because of incorrect type.", path);
    }
    if (err != nullptr) {
  ...
  bool set_property(const char *path, const ten::buf_t &value,
                    error_t *err = nullptr) {
    axis_buf_t buf =
        axis_BUF_STATIC_INIT_WITH_DATA_OWNED(value.data(), value.size());
  ...
  bool on_configure_done(error_t *err = nullptr) {
    ...
    bool rc = axis_env_on_configure_done(
        c_axis_env, err != nullptr ? err->get_c_error() : nullptr);
  ...
  bool on_deinit_done(error_t *err = nullptr) {
    axis_ASSERT(c_axis_env, "Should not happen.");
    return axis_env_on_deinit_done(
        c_axis_env, err != nullptr ? err->get_c_error() : nullptr);
  }

  bool on_start_done(error_t *err = nullptr) {
    axis_ASSERT(c_axis_env, "Should not happen.");
    return axis_env_on_start_done(c_axis_env,
                                 err != nullptr ? err->get_c_error() : nullptr);
  }

  bool on_stop_done(error_t *err = nullptr) {
    axis_ASSERT(c_axis_env, "Should not happen.");
    return axis_env_on_stop_done(c_axis_env,
                                err != nullptr ? err->get_c_error() : nullptr);
  }
  ...
  bool on_destroy_instance_done(void *context, error_t *err = nullptr) {
    bool rc = axis_env_on_destroy_instance_done(
        c_axis_env, context, err != nullptr ? err->get_c_error() : nullptr);

    return rc;
  }

#define axis_ENV_LOG_VERBOSE(axis_env, msg)                                      \
  do {                                                                         \
    (axis_env).log(axis_LOG_LEVEL_VERBOSE, __func__, __FILE__, __LINE__, (msg)); \
  } while (0)

#define axis_ENV_LOG_DEBUG(axis_env, msg)                                      \
  do {                                                                       \
    (axis_env).log(axis_LOG_LEVEL_DEBUG, __func__, __FILE__, __LINE__, (msg)); \
  } while (0)

#define axis_ENV_LOG_INFO(axis_env, msg)                                      \
  do {                                                                      \
    (axis_env).log(axis_LOG_LEVEL_INFO, __func__, __FILE__, __LINE__, (msg)); \
  } while (0)

#define axis_ENV_LOG_WARN(axis_env, msg)                                      \
  do {                                                                      \
    (axis_env).log(axis_LOG_LEVEL_WARN, __func__, __FILE__, __LINE__, (msg)); \
  } while (0)

#define axis_ENV_LOG_ERROR(axis_env, msg)                                      \
  do {                                                                       \
    (axis_env).log(axis_LOG_LEVEL_ERROR, __func__, __FILE__, __LINE__, (msg)); \
  } while (0)

#define axis_ENV_LOG_FATAL(axis_env, msg)                                      \
  do {                                                                       \
    (axis_env).log(axis_LOG_LEVEL_FATAL, __func__, __FILE__, __LINE__, (msg)); \
  } while (0)

  void log(axis_LOG_LEVEL level, const char *func_name, const char *file_name,
           size_t line_no, const char *msg) {
    axis_ASSERT(c_axis_env, "Should not happen.");
    axis_env_log(c_axis_env, level, func_name, file_name, line_no, msg);
  }

 private:
  friend class axis_env_proxy_t;
  friend class app_t;
  friend class extension_t;
  friend class extension_group_t;
  friend class addon_t;
  friend class addon_loader_t;
  friend class axis_env_internal_accessor_t;

  ::axis_env_t *c_axis_env;

  explicit axis_env_t(::axis_env_t *c_axis_env) : c_axis_env(c_axis_env) {
    axis_ASSERT(c_axis_env, "Should not happen.");

    axis_binding_handle_set_me_in_target_lang(
        reinterpret_cast<axis_binding_handle_t *>(c_axis_env),
        static_cast<void *>(this));
  }

  ~axis_env_t() { axis_ASSERT(c_axis_env, "Should not happen."); }

  ::axis_env_t *get_c_axis_env() { return c_axis_env; }

  void *get_attached_target(error_t *err = nullptr) {
    axis_ASSERT(c_axis_env, "Should not happen.");

    return axis_binding_handle_get_me_in_target_lang(
        reinterpret_cast<axis_binding_handle_t *>(
            axis_env_get_attached_target(c_axis_env)));
  }
  ...
  static void proxy_handle_return_error(::axis_env_t *axis_env, void *user_data,
    ...
    if (err != nullptr) {
      ...
      (*error_handler)(*cpp_axis_env, &cpp_err);
    } else {
      (*error_handler)(*cpp_axis_env, nullptr);
    }
  ...
  bool send_cmd_internal(std::unique_ptr<cmd_t> &&cmd,
    ...
    axis_env_send_cmd_func_t send_cmd_func = nullptr;
    if (is_ex) {
    ...
    if (result_handler == nullptr) {
      rc = send_cmd_func(c_axis_env, cmd->get_underlying_msg(), nullptr, nullptr,
                         err != nullptr ? err->get_c_error() : nullptr);
    } else {
      auto *result_handler_ptr =
          new result_handler_func_t(std::move(result_handler));

      rc = send_cmd_func(c_axis_env, cmd->get_underlying_msg(),
  ...
  axis_value_t *peek_property_value(const char *path, error_t *err) {
    axis_ASSERT(c_axis_env, "Should not happen.");

    return axis_env_peek_property(c_axis_env, path,
                                 err != nullptr ? err->get_c_error() : nullptr);
  }
   ...
   */
  bool set_property_impl(const char *path, axis_value_t *value, error_t *err) {
    axis_ASSERT(c_axis_env, "Should not happen.");

    bool rc = axis_env_set_property(
        c_axis_env, path, value, err != nullptr ? err->get_c_error() : nullptr);
  ...
  static void proxy_handle_result(::axis_env_t *axis_env,
    ...
    bool is_completed = axis_cmd_result_is_completed(c_cmd_result, nullptr);

    if (err != nullptr) {
      error_t cpp_err(err, false);
      (*result_handler)(*cpp_axis_env, std::move(cmd_result), &cpp_err);
    } else {
      (*result_handler)(*cpp_axis_env, std::move(cmd_result), nullptr);
    }
  ...
  static void proxy_handle_error(::axis_env_t *axis_env,
                                 axis_shared_ptr_t *c_cmd_result, void *cb_data,
                                 axis_error_t *err) {
    axis_ASSERT(c_cmd_result == nullptr, "Should not happen.");
