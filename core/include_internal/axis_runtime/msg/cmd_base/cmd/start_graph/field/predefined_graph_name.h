...
axis_RUNTIME_PRIVATE_API void axis_cmd_start_graph_copy_predefined_graph_name(
    axis_msg_t *self, axis_msg_t *src, axis_list_t *excluded_field_ids);

axis_RUNTIME_PRIVATE_API bool axis_cmd_start_graph_process_predefined_graph_name(
