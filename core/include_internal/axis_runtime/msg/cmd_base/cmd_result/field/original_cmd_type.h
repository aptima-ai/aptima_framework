...
typedef struct axis_http_t axis_http_t;
typedef struct axis_error_t axis_error_t;

axis_RUNTIME_PRIVATE_API void axis_cmd_result_copy_original_cmd_type(
    axis_msg_t *self, axis_msg_t *src, axis_list_t *excluded_field_ids);

axis_RUNTIME_PRIVATE_API bool axis_cmd_result_process_original_cmd_type(
