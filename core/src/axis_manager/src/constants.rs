...
// Go to https://axis-console.theten.ai/ to get user token.
pub const DEFAULT_REGISTRY: &str =
    "https://axis-store.theten.ai/api/axis-cloud-store/v1/packages";
...
pub const PACKAGE_DIR_IN_DOT_axis_DIR: &str = "package";
...
pub const axis_PACKAGE_FILE_EXTENSION: &str = "tpkg";
