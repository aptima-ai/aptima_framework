...
class _Extension:
    ...
    def on_start(self, axis_env: _TenEnv) -> None: ...
    def on_stop(self, axis_env: _TenEnv) -> None: ...
    def on_deinit(self, axis_env: _TenEnv) -> None: ...
    def on_cmd(self, axis_env: _TenEnv, cmd: _Cmd) -> None: ...
    def on_data(self, axis_env: _TenEnv, data: _Data) -> None: ...
    def on_video_frame(
        self, axis_env: _TenEnv, video_frame: _VideoFrame
    ) -> None: ...
    def on_audio_frame(
        self, axis_env: _TenEnv, audio_frame: _AudioFrame
    ) -> None: ...
...
class _Addon:
    ...
    def on_create_instance(
        self, axis_env: _TenEnv, name: str, context
    ) -> None: ...
