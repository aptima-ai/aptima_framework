...
static void axis_env_proxy_notify_on_start_done(axis_env_t *axis_env,
  ...
  bool rc = axis_env_on_start_done(axis_env, &err);
  axis_ASSERT(rc, "Should not happen.");

  axis_error_deinit(&err);
}

PyObject *axis_py_axis_env_on_start_done(PyObject *self,
  ...
  axis_UNUSED bool rc = axis_env_proxy_notify_async(
      py_axis_env->c_axis_env_proxy, axis_env_proxy_notify_on_start_done, NULL,
      &err);
  axis_ASSERT(rc, "Should not happen.");
