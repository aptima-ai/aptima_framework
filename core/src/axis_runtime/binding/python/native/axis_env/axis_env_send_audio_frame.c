...
static void axis_env_proxy_notify_send_audio_frame(axis_env_t *axis_env,
  ...
  axis_env_notify_send_audio_frame_ctx_t *notify_info = notify_info_;
...
PyObject *axis_py_axis_env_send_audio_frame(PyObject *self, PyObject *args) {
  ...
  axis_shared_ptr_t *cloned_audio_frame =
      axis_shared_ptr_clone(py_audio_frame->msg.c_msg);
  axis_env_notify_send_audio_frame_ctx_t *notify_info =
      axis_env_notify_send_audio_frame_ctx_create(cloned_audio_frame, cb_func);
