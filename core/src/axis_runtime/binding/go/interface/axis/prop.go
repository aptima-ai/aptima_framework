...
// propType is an alias of axis_TYPE from APTIMA runtime.
type propType uint8
...
func getPropInt8(retrieve func(*C.int8_t) C.axis_go_error_t) (int8, error) {
	var cv C.int8_t
...
func getPropInt16(retrieve func(*C.int16_t) C.axis_go_error_t) (int16, error) {
	var cv C.int16_t
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
		return 0, err
...
func getPropInt32(retrieve func(*C.int32_t) C.axis_go_error_t) (int32, error) {
	var cv C.int32_t
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
		return 0, err
...
func getPropInt64(retrieve func(*C.int64_t) C.axis_go_error_t) (int64, error) {
	var cv C.int64_t
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
		return 0, err
...
func getPropUint8(retrieve func(*C.uint8_t) C.axis_go_error_t) (uint8, error) {
	var cv C.uint8_t
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
		return 0, err
...
func getPropUint16(
	retrieve func(*C.uint16_t) C.axis_go_error_t,
) (uint16, error) {
	var cv C.uint16_t
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
...
func getPropUint32(
	retrieve func(*C.uint32_t) C.axis_go_error_t,
) (uint32, error) {
	var cv C.uint32_t
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
...
func getPropUint64(
	retrieve func(*C.uint64_t) C.axis_go_error_t,
) (uint64, error) {
	var cv C.uint64_t
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
...
func getPropBool(retrieve func(*C.bool) C.axis_go_error_t) (bool, error) {
	var cv C.bool
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
		return false, err
...
func getPropFloat32(
	retrieve func(*C.float) C.axis_go_error_t,
) (float32, error) {
	var cv C.float
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
...
func getPropFloat64(
	retrieve func(*C.double) C.axis_go_error_t,
) (float64, error) {
	var cv C.double
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
...
func getPropStr(
	size uintptr,
	retrieve func(unsafe.Pointer) C.axis_go_error_t,
) (string, error) {
	if size == 0 {
...
func getPropPtr(
	retrieve func(*cHandle) C.axis_go_error_t,
) (any, error) {
	var cv cHandle
	apiStatus := retrieve(&cv)
	if err := withCGoError(&apiStatus); err != nil {
