...
// StatusCode is an alias of axis_STATUS_CODE from TEN runtime.
...
const (
	...
	// StatusCodeOk is an alias of axis_STATUS_CODE_OK from TEN runtime.
	StatusCodeOk = 0

	// StatusCodeError is an alias of axis_STATUS_CODE_ERROR from TEN runtime.
	StatusCodeError = 1
