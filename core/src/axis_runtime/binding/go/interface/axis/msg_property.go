...
func (p *msg) getPropertyTypeAndSize(
	...
	// README.md.
	apiStatus := C.axis_go_msg_property_get_type_and_size(
		p.cPtr,
...
func (p *msg) getPropertyString(path string) (string, error) {
	...
	return getPropStr(
		...
		func(v unsafe.Pointer) C.axis_go_error_t {
			return C.axis_go_msg_property_get_string(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) getPropertyBytes(path string) ([]byte, error) {
	...
	return getPropBytes(
		uintptr(pSize),
		func(v unsafe.Pointer) C.axis_go_error_t {
			return C.axis_go_msg_property_get_buf(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyInt8(path string) (int8, error) {
	...
	return withCGOLimiterHasReturnValue[int8](func() (int8, error) {
		return getPropInt8(func(v *C.int8_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_int8(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyInt16(path string) (int16, error) {
	...
	return withCGOLimiterHasReturnValue[int16](func() (int16, error) {
		return getPropInt16(func(v *C.int16_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_int16(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyInt32(path string) (int32, error) {
	...
	return withCGOLimiterHasReturnValue[int32](func() (int32, error) {
		return getPropInt32(func(v *C.int32_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_int32(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyInt64(path string) (int64, error) {
	...
	return withCGOLimiterHasReturnValue[int64](func() (int64, error) {
		return getPropInt64(func(v *C.int64_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_int64(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyUint8(path string) (uint8, error) {
	...
	return withCGOLimiterHasReturnValue[uint8](func() (uint8, error) {
		return getPropUint8(func(v *C.uint8_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_uint8(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyUint16(path string) (uint16, error) {
	...
	return withCGOLimiterHasReturnValue[uint16](func() (uint16, error) {
		return getPropUint16(func(v *C.uint16_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_uint16(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyUint32(path string) (uint32, error) {
	...
	return withCGOLimiterHasReturnValue[uint32](func() (uint32, error) {
		return getPropUint32(func(v *C.uint32_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_uint32(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyUint64(path string) (uint64, error) {
	...
	return withCGOLimiterHasReturnValue[uint64](func() (uint64, error) {
		return getPropUint64(func(v *C.uint64_t) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_uint64(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyFloat32(path string) (float32, error) {
	...
	return withCGOLimiterHasReturnValue[float32](func() (float32, error) {
		return getPropFloat32(func(v *C.float) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_float32(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyFloat64(path string) (float64, error) {
	...
	return withCGOLimiterHasReturnValue[float64](func() (float64, error) {
		return getPropFloat64(func(v *C.double) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_float64(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyBool(path string) (bool, error) {
	...
	return withCGOLimiterHasReturnValue[bool](func() (bool, error) {
		return getPropBool(func(v *C.bool) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_bool(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) GetPropertyPtr(path string) (any, error) {
	...
	return withCGOLimiterHasReturnValue[any](func() (any, error) {
		return getPropPtr(func(v *cHandle) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_msg_property_get_ptr(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				v,
...
func (p *msg) setPropertyString(path string, value string) error {
	apiStatus := C.axis_go_msg_property_set_string(
		p.cPtr,
		unsafe.Pointer(unsafe.StringData(path)),
		C.int(len(path)),
...
func (p *msg) setPropertyBytes(path string, value []byte) error {
	...
	apiStatus := C.axis_go_msg_property_set_buf(
		p.cPtr,
		unsafe.Pointer(unsafe.StringData(path)),
		C.int(len(path)),
...
func (p *msg) setProperty(path string, value any) error {
	...
	switch pt {
	case propTypeBool:
		apiStatus := C.axis_go_msg_property_set_bool(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			C.bool(value.(bool)),
	...
	case propTypeInt8:
		apiStatus := C.axis_go_msg_property_set_int8(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			C.int8_t(value.(int8)),
	...
	case propTypeInt16:
		apiStatus := C.axis_go_msg_property_set_int16(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeInt32:
		apiStatus := C.axis_go_msg_property_set_int32(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeInt64:
		apiStatus := C.axis_go_msg_property_set_int64(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeUint8:
		apiStatus := C.axis_go_msg_property_set_uint8(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeUint16:
		apiStatus := C.axis_go_msg_property_set_uint16(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeUint32:
		apiStatus := C.axis_go_msg_property_set_uint32(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeUint64:
		apiStatus := C.axis_go_msg_property_set_uint64(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeFloat32:
		apiStatus := C.axis_go_msg_property_set_float32(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypeFloat64:
		apiStatus := C.axis_go_msg_property_set_float64(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
	...
	case propTypePtr:
		...
		apiStatus := C.axis_go_msg_property_set_ptr(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			cHandle(vh),
...
func (p *msg) setPropertyFromJSONBytes(path string, value []byte) error {
	...
	apiStatus := C.axis_go_msg_property_set_json_bytes(
		p.cPtr,
		unsafe.Pointer(unsafe.StringData(path)),
		C.int(len(path)),
		unsafe.Pointer(unsafe.SliceData(value)),
...
func (p *msg) getPropertyToJSONBytes(path string) ([]byte, error) {
	...
	apiStatus := C.axis_go_msg_property_get_json_and_size(
		p.cPtr,
		unsafe.Pointer(unsafe.StringData(path)),
		C.int(len(path)),
		&cJSONStrLen,
