...
func NewVideoFrame(videoFrameName string) (VideoFrame, error) {
	...
	return withCGOLimiterHasReturnValue[VideoFrame](func() (VideoFrame, error) {
		...
		apiStatus := C.axis_go_video_frame_create(
...
func (p *videoFrame) AllocBuf(size int) error {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_alloc_buf(p.getCPtr(), C.int(size))
...
func (p *videoFrame) LockBuf() ([]byte, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_lock_buf(
			p.getCPtr(),
			&bufAddr,
			&bufSize,
		)
...
func (p *videoFrame) UnlockBuf(buf *[]byte) error {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_unlock_buf(
			p.getCPtr(),
...
func (p *videoFrame) GetBuf() ([]byte, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_get_buf_size(p.getCPtr(), &bufSize)
		return withCGoError(&apiStatus)
	})
	...
	err = withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_get_buf(
			p.getCPtr(),
...
func (p *videoFrame) SetWidth(width int32) error {
	...
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_set_width(
			p.getCPtr(),
			C.int32_t(width),
		)
		return withCGoError(&apiStatus)
...
func (p *videoFrame) GetWidth() (int32, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_get_width(p.getCPtr(), &width)
		return withCGoError(&apiStatus)
	})
...
func (p *videoFrame) SetHeight(height int32) error {
	...
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_set_height(
			p.getCPtr(),
			C.int32_t(height),
		)
		return withCGoError(&apiStatus)
...
func (p *videoFrame) GetHeight() (int32, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_get_height(p.getCPtr(), &height)
		return withCGoError(&apiStatus)
	})
...
func (p *videoFrame) SetTimestamp(timestamp int64) error {
	...
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_set_timestamp(
			p.getCPtr(),
			C.int64_t(timestamp),
		)
		return withCGoError(&apiStatus)
...
func (p *videoFrame) GetTimestamp() (int64, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_get_timestamp(p.getCPtr(), &timestamp)
		return withCGoError(&apiStatus)
	})
...
func (p *videoFrame) IsEOF() (bool, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_is_eof(p.getCPtr(), &isEOF)
		return withCGoError(&apiStatus)
	})
...
func (p *videoFrame) SetEOF(isEOF bool) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_set_eof(
			p.getCPtr(),
			C.bool(isEOF),
		)
		return withCGoError(&apiStatus)
...
func (p *videoFrame) GetPixelFmt() (PixelFmt, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_get_pixel_fmt(p.getCPtr(), &pixelFmt)
		return withCGoError(&apiStatus)
	})
...
func (p *videoFrame) SetPixelFmt(pixelFmt PixelFmt) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_video_frame_set_pixel_fmt(
			p.getCPtr(),
			C.uint32_t(pixelFmt),
		)
		return withCGoError(&apiStatus)
