...
// axis_AUDIO_FRAME_DATA_FMT enum in C.
//
...
func NewAudioFrame(audioFrameName string) (AudioFrame, error) {
	...
	return withCGOLimiterHasReturnValue[AudioFrame](func() (AudioFrame, error) {
		...
		apiStatus := C.axis_go_audio_frame_create(
...
func (p *audioFrame) SetTimestamp(timestamp int64) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_timestamp(
			p.getCPtr(),
			C.int64_t(timestamp),
		)
...
func (p *audioFrame) GetTimestamp() (int64, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_timestamp(
			p.getCPtr(),
			&timestamp,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetSampleRate(sampleRate int32) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_sample_rate(
			p.getCPtr(),
...
func (p *audioFrame) GetSampleRate() (int32, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_sample_rate(
			p.getCPtr(),
			&sampleRate,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetChannelLayout(channelLayout uint64) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_channel_layout(
			p.getCPtr(),
...
func (p *audioFrame) GetChannelLayout() (uint64, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_channel_layout(
			p.getCPtr(),
			&channelLayout,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetSamplesPerChannel(samplesPerChannel int32) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_samples_per_channel(
			p.getCPtr(),
...
func (p *audioFrame) GetSamplesPerChannel() (int32, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_samples_per_channel(
			p.getCPtr(),
			&samplesPerChannel,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetBytesPerSample(bytesPerSample int32) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_bytes_per_sample(
			p.getCPtr(),
...
func (p *audioFrame) GetBytesPerSample() (int32, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_bytes_per_sample(
			p.getCPtr(),
			&bytesPerSample,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetNumberOfChannels(numberOfChannels int32) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_number_of_channels(
			p.getCPtr(),
...
func (p *audioFrame) GetNumberOfChannels() (int32, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_number_of_channels(
			p.getCPtr(),
			&numberOfChannels,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetDataFmt(dataFmt AudioFrameDataFmt) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_data_fmt(
			p.getCPtr(),
			C.uint32_t(dataFmt),
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) GetDataFmt() (AudioFrameDataFmt, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_data_fmt(
			p.getCPtr(),
			&dataFmt,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetLineSize(lineSize int32) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_line_size(
			p.getCPtr(),
			C.int32_t(lineSize),
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) GetLineSize() (int32, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_line_size(
			p.getCPtr(),
			&lineSize,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) AllocBuf(size int) error {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_alloc_buf(
			p.getCPtr(),
			C.int(size),
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) GetBuf() ([]byte, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_buf_size(p.getCPtr(), &bufSize)
		return withCGoError(&apiStatus)
	})
	...
	err = withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_get_buf(
			p.getCPtr(),
...
func (p *audioFrame) LockBuf() ([]byte, error) {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_lock_buf(
			p.getCPtr(),
			&bufAddr,
			&bufSize,
		)
...
func (p *audioFrame) UnlockBuf(buf *[]byte) error {
	...
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_unlock_buf(
			p.getCPtr(),
...
func (p *audioFrame) IsEOF() (bool, error) {
	var isEOF C.bool
	err := withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_is_eof(
			p.getCPtr(),
			&isEOF,
		)
		return withCGoError(&apiStatus)
...
func (p *audioFrame) SetEOF(isEOF bool) error {
	return withCGOLimiter(func() error {
		apiStatus := C.axis_go_audio_frame_set_eof(
			p.getCPtr(),
			C.bool(isEOF),
		)
		return withCGoError(&apiStatus)
