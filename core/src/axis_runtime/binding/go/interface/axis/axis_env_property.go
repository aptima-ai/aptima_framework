...
func (p *tenEnv) getPropertyTypeAndSize(
	...
	apiStatus := C.axis_go_axis_env_get_property_type_and_size(
		p.cPtr,
...
func (p *tenEnv) GetPropertyInt8(path string) (int8, error) {
	...
	return getPropInt8(func(v *C.int8_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_int8(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyInt16(path string) (int16, error) {
	...
	return getPropInt16(func(v *C.int16_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_int16(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyInt32(path string) (int32, error) {
	...
	return getPropInt32(func(v *C.int32_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_int32(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyInt64(path string) (int64, error) {
	...
	return getPropInt64(func(v *C.int64_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_int64(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyUint8(path string) (uint8, error) {
	...
	return getPropUint8(func(v *C.uint8_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_uint8(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyUint16(path string) (uint16, error) {
	...
	return getPropUint16(func(v *C.uint16_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_uint16(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyUint32(path string) (uint32, error) {
	...
	return getPropUint32(func(v *C.uint32_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_uint32(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyUint64(path string) (uint64, error) {
	...
	return getPropUint64(func(v *C.uint64_t) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_uint64(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyFloat32(path string) (float32, error) {
	...
	return getPropFloat32(func(v *C.float) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_float32(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyFloat64(path string) (float64, error) {
	...
	return getPropFloat64(func(v *C.double) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_float64(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyBool(path string) (bool, error) {
	...
	return getPropBool(func(v *C.bool) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_bool(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyPtr(path string) (any, error) {
	...
	return getPropPtr(func(v *cHandle) C.axis_go_error_t {
		defer p.keepAlive()
		return C.axis_go_axis_env_get_property_ptr(
			p.cPtr,
			unsafe.Pointer(unsafe.StringData(path)),
			C.int(len(path)),
			v,
...
func (p *tenEnv) GetPropertyString(path string) (string, error) {
	...
	if realPt != propTypeStr {
		// The axis_value_t is cloned in APTIMA runtime, so we have to destroy it.
	...
	return getPropStr(
		uintptr(pSize),
		func(v unsafe.Pointer) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_value_get_string(cValue, v)
		},
	)
}
...
func (p *tenEnv) GetPropertyBytes(path string) ([]byte, error) {
	...
	return getPropBytes(
		...
		func(v unsafe.Pointer) C.axis_go_error_t {
			defer p.keepAlive()
			return C.axis_go_value_get_buf(cValue, v)
		},
	)
}
...
func (p *tenEnv) SetProperty(path string, value any) error {
	...
	return withCGO(func() error {
		...
		switch pt {
		case propTypeBool:
			apiStatus := C.axis_go_axis_env_set_property_bool(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				C.bool(value.(bool)),
		...
		case propTypeInt8:
			apiStatus := C.axis_go_axis_env_set_property_int8(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				C.int8_t(value.(int8)),
		...
		case propTypeInt16:
			apiStatus := C.axis_go_axis_env_set_property_int16(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeInt32:
			apiStatus := C.axis_go_axis_env_set_property_int32(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeInt64:
			apiStatus := C.axis_go_axis_env_set_property_int64(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeUint8:
			apiStatus := C.axis_go_axis_env_set_property_uint8(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeUint16:
			apiStatus := C.axis_go_axis_env_set_property_uint16(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeUint32:
			apiStatus := C.axis_go_axis_env_set_property_uint32(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeUint64:
			apiStatus := C.axis_go_axis_env_set_property_uint64(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeFloat32:
			apiStatus := C.axis_go_axis_env_set_property_float32(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeFloat64:
			apiStatus := C.axis_go_axis_env_set_property_float64(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeStr:
			vs := value.(string)
			apiStatus := C.axis_go_axis_env_set_property_string(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypeBuf:
			vb := value.([]byte)
			apiStatus := C.axis_go_axis_env_set_property_buf(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
		...
		case propTypePtr:
			...
			apiStatus := C.axis_go_axis_env_set_property_ptr(
				p.cPtr,
				unsafe.Pointer(unsafe.StringData(path)),
				C.int(len(path)),
				cHandle(vh),
...
func (p *tenEnv) setPropertyFromJSONBytes(path string, value []byte) error {
	...
	apiStatus := C.axis_go_axis_env_set_property_json_bytes(
		p.cPtr,
		unsafe.Pointer(unsafe.StringData(path)),
		C.int(len(path)),
		unsafe.Pointer(unsafe.SliceData(value)),
...
func (p *tenEnv) getPropertyToJSONBytes(path string) ([]byte, error) {
	...
	apiStatus := C.axis_go_axis_env_get_property_json_and_size(
		p.cPtr,
		unsafe.Pointer(unsafe.StringData(path)),
		C.int(len(path)),
		&cJSONStrLen,
	...
	return getPropBytes(size, func(v unsafe.Pointer) C.axis_go_error_t {
		return C.axis_go_copy_c_str_to_slice_and_free(cJSONStr, v)
	})
}
...
func (p *tenEnv) InitPropertyFromJSONBytes(value []byte) error {
	...
	apiStatus := C.axis_go_axis_env_init_property_from_json_bytes(
		p.cPtr,
		unsafe.Pointer(unsafe.SliceData(value)),
		C.int(len(value)),
	)
