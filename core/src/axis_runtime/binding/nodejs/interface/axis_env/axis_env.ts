...
export class TenEnv {
  async sendCmd(cmd: Cmd): Promise<[CmdResult | null, Error | null]> {
    return new Promise<[CmdResult | null, Error | null]>((resolve) => {
      axis_addon.axis_nodejs_axis_env_send_cmd(
        this,
        cmd,
  ...
  async sendData(data: Data): Promise<Error | null> {
    return new Promise<Error | null>((resolve) => {
      axis_addon.axis_nodejs_axis_env_send_data(
        this,
        data,
        async (error: Error) => {
          resolve(error);
  ...
  async sendVideoFrame(videoFrame: VideoFrame): Promise<Error | null> {
    return new Promise<Error | null>((resolve) => {
      axis_addon.axis_nodejs_axis_env_send_video_frame(
        this,
        videoFrame,
        async (error: Error) => {
          resolve(error);
  ...
  async sendAudioFrame(audioFrame: AudioFrame): Promise<Error | null> {
    return new Promise<Error | null>((resolve) => {
      axis_addon.axis_nodejs_axis_env_send_audio_frame(
        this,
        audioFrame,
        async (error: Error) => {
          resolve(error);
  ...
  async returnResult(
    ...
    return new Promise<Error | null>((resolve) => {
      axis_addon.axis_nodejs_axis_env_return_result(
        this,
        cmdResult,
        targetCmd,
        async (error: Error) => {
  ...
  async returnResultDirectly(cmdResult: CmdResult): Promise<Error | null> {
    return new Promise<Error | null>((resolve) => {
      axis_addon.axis_nodejs_axis_env_return_result_directly(
        this,
        cmdResult,
        async (error: Error) => {
          resolve(error);
  ...
  async isPropertyExist(path: string): Promise<boolean> {
    return new Promise<boolean>((resolve) => {
      axis_addon.axis_nodejs_axis_env_is_property_exist(
        this,
        path,
  ...
  async getPropertyToJson(path: string): Promise<string> {
    return new Promise<string>((resolve, reject) => {
      axis_addon.axis_nodejs_axis_env_get_property_to_json(
        this,
        path,
  ...
  async setPropertyFromJson(path: string, jsonStr: string): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      axis_addon.axis_nodejs_axis_env_set_property_from_json(
        this,
        path,
        jsonStr,
        async (error: Error) => {
  ...
  async getPropertyNumber(path: string): Promise<number> {
    return new Promise<number>((resolve, reject) => {
      axis_addon.axis_nodejs_axis_env_get_property_number(
        this,
        path,
  ...
  async setPropertyNumber(path: string, value: number): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      axis_addon.axis_nodejs_axis_env_set_property_number(
        this,
        path,
        value,
        async (error: Error) => {
  ...
  async getPropertyString(path: string): Promise<string> {
    return new Promise<string>((resolve, reject) => {
      axis_addon.axis_nodejs_axis_env_get_property_string(
        this,
        path,
        async (result: string, error: Error) => {
          if (error) {
  ...
  async setPropertyString(path: string, value: string): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      axis_addon.axis_nodejs_axis_env_set_property_string(
        this,
        path,
        value,
        async (error: Error) => {
  ...
  async initPropertyFromJson(jsonStr: string): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      axis_addon.axis_nodejs_axis_env_init_property_from_json(
        this,
        jsonStr,
        async (error: Error) => {
          if (error) {
  ...
  private log_internal(level: number, message: string): void {
    ...
    axis_addon.axis_nodejs_axis_env_log_internal(
      this,
      level,
      callerFunction,
      callerFile,
...
axis_addon.axis_nodejs_axis_env_register_class(TenEnv);
