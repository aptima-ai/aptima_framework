...
ten_msg_conversion_per_property_t *ten_msg_conversion_per_property_from_json(
  ...
  ten_msg_conversion_per_property_rules_t *rules =
      ten_msg_conversion_per_property_rules_from_json(
...
ten_json_t *ten_msg_conversion_per_property_to_json(
  ...
  ten_json_t *rules_json =
      ten_msg_conversion_per_property_rules_to_json(self->rules, err);
  if (!rules_json) {
