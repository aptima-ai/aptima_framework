...
#[no_mangle]
pub extern "C" fn axis_validate_manifest_json_string(
    ...
    let ret =
        json_schema::axis_validate_manifest_json_string(rust_manifest_data);
    if ret.is_err() {
...
#[no_mangle]
pub extern "C" fn axis_validate_manifest_json_file(
    ...
    let ret = json_schema::axis_validate_manifest_json_file(rust_manifest_file);
    if ret.is_err() {
        let err_msg = ret.err().unwrap().to_string();
        let c_err_msg =
            CString::new(err_msg).expect("Failed to allocate memory.");
...
#[no_mangle]
pub extern "C" fn axis_validate_property_json_string(
    ...
    let ret =
        json_schema::axis_validate_property_json_string(rust_property_data);
    if ret.is_err() {
        let err_msg = ret.err().unwrap().to_string();
        let c_err_msg =
            CString::new(err_msg).expect("Failed to allocate memory.");
...
#[no_mangle]
pub extern "C" fn axis_validate_property_json_file(
    ...
    let ret = json_schema::axis_validate_property_json_file(rust_property_file);
    if ret.is_err() {
        let err_msg = ret.err().unwrap().to_string();
        let c_err_msg =
            CString::new(err_msg).expect("Failed to allocate memory.");
