...
use crate::{
    ...
    schema::{
        store::{
            are_cmd_schemas_compatible, are_axis_schemas_compatible, CmdSchema,
        },
        TenSchema,
    },
};
    ...
    all_pkgs
        ...
        .ok_or_else(|| {
            anyhow::anyhow!(
                ...
                found, check your addons in axis_packages/extension.",
                extension.addon,
...
pub fn get_compatible_data_like_msg_extension<'a>(
    ...
    for ext in extensions {
        ...
        let compatible = match desired_msg_dir {
            MsgDirection::In => {
                are_axis_schemas_compatible(pivot, target_msg_schema)
            }
            MsgDirection::Out => {
                are_axis_schemas_compatible(target_msg_schema, pivot)
            }
        };
