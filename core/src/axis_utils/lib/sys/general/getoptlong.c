...
#include "axis_utils/lib/getoptlong.h"
...
static const axis_opt_long_t *get_opt_short(const axis_opt_long_t *opts,
                                           int short_flag) {
  if (short_flag <= 0) {
    return NULL;
  }
  const axis_opt_long_t *itor = opts;
...
static const axis_opt_long_t *get_opt_long(const axis_opt_long_t *opts,
...
void axis_print_help(const char *exec_name, const axis_opt_long_t *opts) {
...
int axis_getopt_long(int argc, const char **argv, const axis_opt_long_t *opts,
                    char **p) {
  ...
  const axis_opt_long_t *opt = get_opt_short(opts, short_flag);
