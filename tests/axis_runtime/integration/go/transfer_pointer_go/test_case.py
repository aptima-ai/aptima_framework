...
def test_transfer_pointer_go():
    ...
    source_pkg_name = "transfer_pointer_go_app"
    ...
    if sys.platform == "win32":
        ...
        my_env["DYLD_LIBRARY_PATH"] = os.path.join(
            base_path,
            "transfer_pointer_go_app/aptima_packages/system/aptima_runtime/lib",
        )
    else:
        # client depends on some libraries in the TEN app.
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "transfer_pointer_go_app/aptima_packages/system/aptima_runtime/lib/libasan.so",
            )
