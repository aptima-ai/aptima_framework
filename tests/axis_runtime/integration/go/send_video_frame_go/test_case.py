...
def test_send_video_frame_go():
    ...
    source_pkg_name = "send_video_frame_go_app"
    ...
    if sys.platform == "win32":
        ...
        my_env["DYLD_LIBRARY_PATH"] = os.path.join(
            base_path,
            "send_video_frame_go_app/aptima_packages/system/aptima_runtime/lib",
        )
    else:
        # client depends on some libraries in the APTIMA app.
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "send_video_frame_go_app/aptima_packages/system/aptima_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The send_video_frame_go is not started after 10 seconds.")
