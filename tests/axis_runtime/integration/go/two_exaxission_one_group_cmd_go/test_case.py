...
def test_two_extension_on_group_cmd_go():
    ...
    if sys.platform == "win32":
        ...
        my_env["DYLD_LIBRARY_PATH"] = os.path.join(
            base_path,
            "two_extension_one_group_cmd_go_app/axis_packages/system/axis_runtime/lib",
        )
    else:
        # client depends on some libraries in the TEN app.
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "two_extension_one_group_cmd_go_app/axis_packages/system/axis_runtime/lib/libasan.so",
            )
