...
def test_send_data_go():
    ...
    source_pkg_name = "send_data_go_app"
    ...
    if sys.platform == "win32":
        ...
        my_env["DYLD_LIBRARY_PATH"] = os.path.join(
            base_path,
            "send_data_go_app/aptima_packages/system/aptima_runtime/lib",
        )
    else:
        # client depends on some libraries in the TEN app.
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "send_data_go_app/aptima_packages/system/aptima_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The send_data_go is not started after 10 seconds.")
