...
def test_start_app_sync_go():
    ...
    source_pkg_name = "start_app_sync_go_app"
    ...
    if sys.platform == "win32":
        ...
        my_env["DYLD_LIBRARY_PATH"] = os.path.join(
            base_path,
            "start_app_sync_go_app/axis_packages/system/axis_runtime/lib",
        )
    else:
        # client depends on some libraries in the TEN app.
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "start_app_sync_go_app/axis_packages/system/axis_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The start_app_sync_go is not started after 10 seconds.")
