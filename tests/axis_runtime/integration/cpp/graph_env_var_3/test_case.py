...
def test_graph_env_var_3_app():
    ...
    if sys.platform == "win32":
        my_env["PATH"] = (
            os.path.join(
                base_path,
                "graph_env_var_3_app/axis_packages/system/axis_runtime/lib",
            )
            + ";"
            + my_env["PATH"]
        )
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "graph_env_var_3_app/axis_packages/system/axis_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The graph_env_var_3_app is not started after 10 seconds.")
