...
class ffmpeg_client_extension : public aptima::extension_t {
 public:
  ...
  void on_start(aptima::aptima_env_t &aptima_env) override {
    ...
    aptima_env.send_cmd(
        std::move(cmd), [](aptima::aptima_env_t &aptima_env,
                           ...
                           aptima_UNUSED aptima::error_t * /*error*/) {
  ...
  void on_video_frame(
      aptima::aptima_env_t &aptima_env,
      aptima_UNUSED std::unique_ptr<aptima::video_frame_t> frame) override {
    // bypass
  ...
  void on_audio_frame(
      aptima::aptima_env_t &aptima_env,
      aptima_UNUSED std::unique_ptr<aptima::audio_frame_t> frame) override {
    // bypass
