...
def test_ffmpeg_basic_app():
    ...
    if sys.platform == "win32":
        my_env["PATH"] = (
            os.path.join(
                base_path,
                "ffmpeg_basic_app/axis_packages/system/axis_runtime/lib",
            )
            + ";"
            + my_env["PATH"]
        )
        ...
        my_env["DYLD_LIBRARY_PATH"] = os.path.join(
            base_path, "ffmpeg_basic_app/axis_packages/system/axis_runtime/lib"
        )
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "ffmpeg_basic_app/axis_packages/system/axis_runtime/lib/libasan.so",
            )
