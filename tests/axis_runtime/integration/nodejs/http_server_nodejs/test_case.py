...
def test_http_server_nodejs():
    ...
    source_pkg_name = "http_server_nodejs_app"
    ...
    if sys.platform == "linux":
        if build_config_args.enable_sanitizer:
            libasan_path = os.path.join(
                base_path,
                "http_server_nodejs_app/aptima_packages/system/aptima_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The http_server_nodejs is not started after 10 seconds.")
