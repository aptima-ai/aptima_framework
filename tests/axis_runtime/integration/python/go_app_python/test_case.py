...
def test_go_app_python():
    ...
    source_pkg_name = "go_app_python_app"
    ...
    if sys.platform == "linux":
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "go_app_python_app/aptima_packages/system/aptima_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The go_app_python is not started after 10 seconds.")
