...
def test_no_dest_async_python():
    ...
    source_pkg_name = "no_dest_async_python_app"
    ...
    if sys.platform == "linux":
        if build_config_args.enable_sanitizer:
            libasan_path = os.path.join(
                base_path,
                "no_dest_async_python_app/aptima_packages/system/aptima_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The no_dest_async_python is not started after 10 seconds.")
