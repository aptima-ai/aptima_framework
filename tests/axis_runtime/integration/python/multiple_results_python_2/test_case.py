...
def test_multiple_results_python_2():
    ...
    source_pkg_name = "multiple_results_python_2_app"
    ...
    if sys.platform == "linux":
        if build_config_args.enable_sanitizer:
            libasan_path = os.path.join(
                base_path,
                "multiple_results_python_2_app/aptima_packages/system/aptima_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The multiple_results_python_2 is not started after 10 seconds.")
