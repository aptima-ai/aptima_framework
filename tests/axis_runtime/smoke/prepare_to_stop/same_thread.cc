...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(prepare_to_stop_same_thread__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(prepare_to_stop_same_thread__extension_2,
                                    test_extension_2);
