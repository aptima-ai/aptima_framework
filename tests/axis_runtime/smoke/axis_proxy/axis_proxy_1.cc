...
class test_extension_1 : public ten::extension_t {
 public:
  ...
  void outer_thread_main(ten::axis_env_proxy_t *axis_env_proxy) {  // NOLINT
    ...
    // Wait 2 seconds.
    axis_LOGD("Waiting 2 seconds...");
    axis_sleep(2000);

    // Before deleting axis_env_proxy, this extension will not be removed, so
  ...
  void on_start(ten::axis_env_t &axis_env) override {
    ...
    // Create a axis_env_proxy, and this will prevent TEN runtime from closing.
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(axis_proxy_1__test_extension_1,
                                    test_extension_1);
...
TEST(ExtensionTest, TenEnvProxy1) {  // NOLINT
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
               ...
               "addon": "axis_proxy_1__test_extension_1",
