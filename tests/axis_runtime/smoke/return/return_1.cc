...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(return_1__extension_1, test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(return_1__extension_2, test_extension_2);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(return_1__extension_3, test_extension_3);
