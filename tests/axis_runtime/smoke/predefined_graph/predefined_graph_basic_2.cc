        ...
        [&](ten::axis_env_t &axis_env,
          ...
          if (cmd_result->get_status_code() == axis_STATUS_CODE_OK) {
            ...
            axis_env.send_cmd(
                ...
                [&, graph_id](ten::axis_env_t &axis_env,
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(predefined_graph_basic_2__predefined_graph,
                                    test_predefined_graph);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(predefined_graph_basic_2__normal_extension,
