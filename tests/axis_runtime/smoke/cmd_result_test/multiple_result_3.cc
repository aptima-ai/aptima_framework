      ...
      aptima_env.send_cmd_ex(
          std::move(cmd), [this](aptima::aptima_env_t &aptima_env,
            ...
            if (cmd_result->is_completed()) {
              aptima_ASSERT(received_result_cnt == 2, "Should not happen.");
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multiple_result_3__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multiple_result_3__test_extension_2,
                                    test_extension_2);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multiple_result_3__test_extension_3,
                                    test_extension_3);
