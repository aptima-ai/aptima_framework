      ...
      axis_env.send_cmd(
          std::move(cmd), [this](ten::axis_env_t &axis_env,
            ...
            if (cmd_result->is_completed()) {
              axis_ASSERT(received_result_cnt == 1, "Should not happen.");
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(multiple_result_2__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(multiple_result_2__test_extension_2,
                                    test_extension_2);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(multiple_result_2__test_extension_3,
                                    test_extension_3);
