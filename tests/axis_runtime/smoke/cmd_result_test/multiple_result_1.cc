  ...
  void on_cmd(ten::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      aptima_env.send_cmd_ex(
          std::move(cmd), [this](ten::aptima_env_t &aptima_env,
...
class test_extension_2 : public ten::extension_t {
 public:
  ...
  void on_cmd(ten::aptima_env_t &aptima_env,
              std::unique_ptr<ten::cmd_t> cmd) override {
    if (cmd->get_name() == "hello_world") {
      auto cmd_result_1 = ten::cmd_result_t::create(aptima_STATUS_CODE_OK);
      ...
      auto cmd_result_2 = ten::cmd_result_t::create(aptima_STATUS_CODE_OK);
