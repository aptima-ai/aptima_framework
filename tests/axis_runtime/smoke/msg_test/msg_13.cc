...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_13__extension_1, test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_13__extension_2, test_extension_2);
...
TEST(MsgTest, Msg13) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "msg_13__extension_group_1", "msg_13__extension_1");
