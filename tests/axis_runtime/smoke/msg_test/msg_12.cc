...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_12__extension_1, test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_12__extension_2, test_extension_2);
