 ...
 public:
  ...
  void on_cmd(aptima::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      auto new_cmd = aptima::cmd_t::create("test");
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_8__extension_1, test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_8__extension_2, test_extension_2);
...
TEST(MsgTest, Msg8) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "msg_8__extension_group_1", "msg_8__extension_1");
