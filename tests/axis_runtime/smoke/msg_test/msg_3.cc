 ...
 public:
  ...
  void on_cmd(aptima::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      ...
      // Start a timer.
      std::unique_ptr<aptima::cmd_timer_t> timer_cmd = aptima::cmd_timer_t::create();
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_3__extension, test_extension);
...
TEST(MsgTest, Msg3) {
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "msg_3__extension_group", "test_extension");
