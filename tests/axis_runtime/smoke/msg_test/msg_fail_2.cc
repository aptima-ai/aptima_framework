 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      ...
      bool rc = axis_env.send_cmd(std::move(timer_cmd));
      EXPECT_EQ(rc, true);
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_fail_2__extension, test_extension);
...
TEST(MsgTest, MsgFail2) {
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "msg_fail_2__extension_group", "test_extension");
