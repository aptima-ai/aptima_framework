...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_send_in_stop_period__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_send_in_stop_period__extension_2,
                                    test_extension_2);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_send_in_stop_period__extension_3,
                                    test_extension_3);
