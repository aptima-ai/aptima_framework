...
class test_extension_1 : public aptima::extension_t {
 public:
  ...
  void on_stop(aptima::aptima_env_t &aptima_env) override {
    auto cmd = aptima::cmd_t::create("hello_world");
    aptima_env.send_cmd(std::move(cmd));
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_send_in_stop_period__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_send_in_stop_period__extension_2,
                                    test_extension_2);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_send_in_stop_period__extension_3,
                                    test_extension_3);
