...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_resp_when_all__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_resp_when_all__extension_2,
                                    test_extension_2);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(multi_dest_resp_when_all__extension_3,
                                    test_extension_3);

}  // namespace

TEST(ExtensionTest, MultiDestRespWhenAll) {
  // Start app.
  auto *app_thread =
