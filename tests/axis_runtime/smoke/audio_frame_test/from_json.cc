 ...
 public:
  ...
  void on_audio_frame(
    ...
    if (audio_frame->get_bytes_per_sample() == 3 &&
        ...
        audio_frame->get_data_fmt() == axis_AUDIO_FRAME_DATA_FMT_INTERLEAVE) {
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(audio_frame_from_json__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(audio_frame_from_json__test_extension_2,
                                    test_extension_2);
