 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      auto rc =
          axis_env.set_property(PROP_NAME, static_cast<float_t>(PROP_NEW_VAL));
      EXPECT_EQ(rc, true);

      auto prop_value = axis_env.get_property_float32(PROP_NAME);
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(property_set_float32__extension,
                                    test_extension);
