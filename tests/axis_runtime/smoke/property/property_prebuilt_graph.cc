...
class test_extension : public ten::extension_t {
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    auto mode = axis_env.get_property_string("widget_props");
    if (mode.empty()) {
      mode = "default";
    }
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(property_predefined_graph__extension,
                                    test_extension);
...
TEST(PropertyTest, PredefinedGraph) {  // NOLINT
  ...
  axis_test::check_detail_with_string(cmd_result, "1");
