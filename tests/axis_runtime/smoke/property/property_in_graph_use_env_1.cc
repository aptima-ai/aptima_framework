...
class test_extension : public ten::extension_t {
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    auto mode = axis_env.get_property_string("from_env");
    if (mode.empty()) {
      mode = "default";
    }
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(property_in_graph_use_env_1__extension,
                                    test_extension);
...
TEST(PropertyTest, InGraphUseEnv1) {  // NOLINT
  ...
  axis_test::check_detail_with_string(cmd_result, "Luke, I'm your father.");
  ...
  axis_test::check_status_code(cmd_result, axis_STATUS_CODE_OK);
  axis_test::check_detail_with_string(cmd_result, "default");
