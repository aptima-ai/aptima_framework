...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(outer_thread_send_data__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(outer_thread_send_data__test_extension_2,
                                    test_extension_2);
