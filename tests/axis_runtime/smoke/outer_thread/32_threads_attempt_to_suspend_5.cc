...
#include "include_internal/aptima_runtime/binding/cpp/detail/msg/cmd/timer.h"
 ...
 public:
  ...
  void on_data(aptima_UNUSED aptima::aptima_env_t &aptima_env,
    ...
    if (data_received_count % 200 == 0) {
      aptima_LOGD("extension_2 received %d data(s).", data_received_count);
    }
