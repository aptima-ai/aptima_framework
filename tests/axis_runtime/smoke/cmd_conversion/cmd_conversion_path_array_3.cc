...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_mapping_path_array_3__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_mapping_path_array_3__test_extension_2,
                                    test_extension_2);
