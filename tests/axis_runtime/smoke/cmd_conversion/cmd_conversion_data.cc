 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "send_data") {
      ...
      axis_env.send_data(std::move(data));
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_mapping_data_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_mapping_data_extension_2,
                                    test_extension_2);
...
TEST(CmdConversionTest, CmdConversionData) {  // NOLINT
  ...
  axis_test::check_detail_with_string(cmd_result, "data sent");
  ...
  axis_test::check_status_code(cmd_result, axis_STATUS_CODE_OK);
  axis_test::check_detail_with_string(cmd_result, "data received");
