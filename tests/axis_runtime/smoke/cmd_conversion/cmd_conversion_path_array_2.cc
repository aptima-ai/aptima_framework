...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_mapping_path_array_2__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_mapping_path_array_2__test_extension_2,
                                    test_extension_2);
...
TEST(CmdConversionTest, CmdConversionPathArray2) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", "default",
                            "cmd_mapping_path_array_2__extension_group",
                            "test_extension_1");
