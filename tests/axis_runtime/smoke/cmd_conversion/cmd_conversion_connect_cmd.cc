...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_conversion_connect_cmd_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_conversion_connect_cmd_extension_2,
                                    test_extension_2);
...
TEST(CmdConversionTest, CmdConversionConnectCmd) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "cmd_conversion_connect_cmd_extension_group",
                            "test_extension_1");
