...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_conversion_connect_cmd_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(cmd_conversion_connect_cmd_extension_2,
                                    test_extension_2);
