...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_1__test_extension_1,
                                    test_extension_1);

aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_1__test_extension_2,
                                    test_extension_2);
