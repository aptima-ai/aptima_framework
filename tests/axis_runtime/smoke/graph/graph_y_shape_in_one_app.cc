...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_y_shape_in_one_app__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_y_shape_in_one_app__extension_2,
                                    test_extension_2);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_y_shape_in_one_app__extension_3,
                                    test_extension_3);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_y_shape_in_one_app__extension_4,
                                    test_extension_4);
