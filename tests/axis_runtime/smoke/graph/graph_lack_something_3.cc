...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_lack_something_3__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_lack_something_3__extension_2,
                                    test_extension_2);
...
TEST(ExtensionTest, GraphLackSomething3) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "graph_lack_something_3", "test_extension_1");
