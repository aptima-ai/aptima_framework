...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_2__test_extension_1,
                                    test_extension_1);

axis_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_2__test_extension_2,
                                    test_extension_2);
...
TEST(ExtensionTest, GraphOutOfOrder2) {  // NOLINT
  ...
  axis_test::check_status_code(cmd_result, axis_STATUS_CODE_OK);
  axis_test::check_detail_with_string(cmd_result, "hello from test extension 1");
  ...
  axis_test::check_status_code(cmd_result, axis_STATUS_CODE_OK);
  axis_test::check_detail_with_string(cmd_result, "hello from test extension 2");
