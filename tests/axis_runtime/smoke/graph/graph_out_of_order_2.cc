...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_2__test_extension_1,
                                    test_extension_1);

aptima_CPP_REGISTER_ADDON_AS_EXTENSION(graph_out_of_order_2__test_extension_2,
                                    test_extension_2);
...
TEST(ExtensionTest, GraphOutOfOrder2) {  // NOLINT
  ...
  aptima_test::check_status_code(cmd_result, aptima_STATUS_CODE_OK);
  aptima_test::check_detail_with_string(cmd_result, "hello from test extension 1");

  hello_world_cmd = aptima::cmd_t::create("hello_world");
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "test_extension_group 2", "test_extension_2");

  cmd_result = client->send_cmd_and_recv_result(std::move(hello_world_cmd));

  aptima_test::check_status_code(cmd_result, aptima_STATUS_CODE_OK);
  aptima_test::check_detail_with_string(cmd_result, "hello from test extension 2");
