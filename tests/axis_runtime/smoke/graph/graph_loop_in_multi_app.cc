...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(graph_loop_in_multi_app__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(graph_loop_in_multi_app__extension_2,
                                    test_extension_2);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(graph_loop_in_multi_app__extension_3,
                                    test_extension_3);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(graph_loop_in_multi_app__extension_4,
                                    test_extension_4);
