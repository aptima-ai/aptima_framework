 ...
 public:
  ...
  void on_cmd(ten::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      bool rc = aptima_env.send_cmd(std::move(cmd));
      ASSERT_EQ(rc, true);
    }
  }
};
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(schema_cmd_result_error__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(schema_cmd_result_error__test_extension_2,
                                    test_extension_2);
