 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      bool rc = axis_env.send_cmd(std::move(cmd));
      ASSERT_EQ(rc, true);
    }
  }
};
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(schema_cmd_result_error__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(schema_cmd_result_error__test_extension_2,
                                    test_extension_2);
