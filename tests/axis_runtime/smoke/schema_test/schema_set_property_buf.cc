...
#include "aptima_utils/macro/memory.h"
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(schema_set_property_buf__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(schema_set_property_buf__test_extension_2,
                                    test_extension_2);
