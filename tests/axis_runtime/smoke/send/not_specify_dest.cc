  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      for (size_t i = 0; i < 100; ++i) {
        ...
        bool rc = axis_env.send_cmd(std::move(not_specify_dest_cmd));
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(send_not_specify_dest__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(send_not_specify_dest__test_extension_2,
                                    test_extension_2);
