  ...
  void on_cmd(aptima::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      for (size_t i = 0; i < 100; ++i) {
        auto not_specify_dest_cmd = aptima::cmd_t::create("not_specify_dest_cmd");
        bool rc = aptima_env.send_cmd(std::move(not_specify_dest_cmd));
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(send_not_specify_dest__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(send_not_specify_dest__test_extension_2,
                                    test_extension_2);
