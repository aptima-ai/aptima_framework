  ...
  void on_start(ten::axis_env_t &axis_env) override {
    ...
    axis_env.send_cmd(
        ...
        [this](ten::axis_env_t &axis_env, std::unique_ptr<ten::cmd_result_t> cmd,
          ...
          EXPECT_EQ(status_code, axis_STATUS_CODE_ERROR);
          ...
          if (test_cmd != nullptr) {
            ...
            axis_env.return_result(std::move(cmd_result), std::move(test_cmd));
          }
        });
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(start_incorrect_graph__normal_extension,
