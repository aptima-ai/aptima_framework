...
class test_predefined_graph : public ten::extension_t {
 public:
  ...
  static void start_graph_and_greet(
      std::string graph_name, ten::aptima_env_t &aptima_env,
      const std::function<void(ten::aptima_env_t &, const std::string &)> &cb) {
    ...
    aptima_env.send_cmd(
        ...
        [cb](ten::aptima_env_t &aptima_env, std::unique_ptr<ten::cmd_result_t> cmd,
             ten::error_t *err) {
          ...
          aptima_env.send_cmd(
              ...
              [cb, graph_id](ten::aptima_env_t &aptima_env,
  ...
  void on_start(ten::aptima_env_t &aptima_env) override {
    start_graph_and_greet(
        "graph_1", aptima_env,
        [this](ten::aptima_env_t &aptima_env, const std::string &graph_id) {
