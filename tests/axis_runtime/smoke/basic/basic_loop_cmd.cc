 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      ...
      axis_env.send_cmd(std::move(hello_world_1_cmd),
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(basic_loop_cmd__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(basic_loop_cmd__extension_2,
                                    test_extension_2);
