 ...
 public:
  ...
  void on_cmd(aptima::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      ...
      aptima_env.send_cmd(std::move(hello_world_1_cmd),
  ...
  void on_cmd(aptima::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world_1") {
      ...
      aptima_env.send_cmd(std::move(hello_world_2_cmd),
                       [this](aptima_UNUSED aptima::aptima_env_t &aptima_env,
                              aptima_UNUSED std::unique_ptr<aptima::cmd_result_t> cmd,
                              aptima::error_t *err) {
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(basic_loop_cmd__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(basic_loop_cmd__extension_2,
                                    test_extension_2);
