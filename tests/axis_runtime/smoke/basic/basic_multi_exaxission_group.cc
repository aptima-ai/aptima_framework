...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(basic_multi_extension_group__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(basic_multi_extension_group__extension_2,
                                    test_extension_2);
...
TEST(BasicTest, MultiExtensionGroup) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "basic_multi_extension_group__extension_group_1",
                            "test_extension_1");
