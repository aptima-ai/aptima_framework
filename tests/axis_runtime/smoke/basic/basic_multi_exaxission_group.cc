...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(basic_multi_extension_group__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(basic_multi_extension_group__extension_2,
                                    test_extension_2);
