...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(basic_two_extensions__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(basic_two_extensions__test_extension_2,
                                    test_extension_2);
