...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(basic_two_extensions__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(basic_two_extensions__test_extension_2,
                                    test_extension_2);
