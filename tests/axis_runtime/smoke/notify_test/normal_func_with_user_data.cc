...
void extension_on_notify(aptima::aptima_env_t &aptima_env, void *user_data);
...
class test_extension : public aptima::extension_t {
    ...
    while (true) {
      if (trigger) {
        ...
        *user_data = 3;
        ...
        aptima_env_proxy->notify(extension_on_notify, user_data);
 ...
 private:
  friend void extension_on_notify(aptima::aptima_env_t &aptima_env, void *user_data);
