...
void extension_on_notify(ten::axis_env_t &axis_env, void *user_data);
...
class test_extension : public ten::extension_t {
    ...
    while (true) {
      if (trigger) {
        ...
        *user_data = 3;
        ...
        axis_env_proxy->notify(extension_on_notify, user_data);
 ...
 private:
  friend void extension_on_notify(ten::axis_env_t &axis_env, void *user_data);
