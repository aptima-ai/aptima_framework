...
void extension_on_notify(ten::aptima_env_t &aptima_env, void *user_data);
...
class test_extension : public ten::extension_t {
 ...
 private:
  friend void extension_on_notify(ten::aptima_env_t &aptima_env, void *user_data);
...
void extension_on_notify(ten::aptima_env_t &aptima_env, void *user_data) {
  ...
  auto *ext = static_cast<test_extension *>(
      ten::aptima_env_internal_accessor_t::get_attached_target(aptima_env));
