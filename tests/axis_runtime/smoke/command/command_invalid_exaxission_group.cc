...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(command_invalid_extension_group__extension,
                                    test_extension);

}  // namespace

TEST(ExtensionTest, CommandInvalidExtensionGroup) {
  auto *app_thread =
  ...
  axis_test::check_detail_with_string(cmd_result,
