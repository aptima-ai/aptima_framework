 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      int *test_data = reinterpret_cast<int *>(axis_malloc(sizeof(int)));
      *test_data = 12344321;
      ...
      axis_env.send_cmd(
          ...
          [this](ten::axis_env_t &axis_env,
            ...
            axis_env.return_result(std::move(cmd), std::move(hello_world_cmd));
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(command_send_ptr__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(command_send_ptr__extension_2,
                                    test_extension_2);
