...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(result_mapping_1__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(result_mapping_1__test_extension_2,
                                    test_extension_2);
...
TEST(ResultConversionTest, ResultConversion1) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", "default",
                            "result_mapping_1__extension_group",
                            "test_extension_1");
  ...
  aptima_test::check_detail_with_string(cmd_result, "may the force be with you.");
