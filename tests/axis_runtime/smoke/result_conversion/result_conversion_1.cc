...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(result_mapping_1__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(result_mapping_1__test_extension_2,
                                    test_extension_2);
...
TEST(ResultConversionTest, ResultConversion1) {  // NOLINT
  ...
  axis_test::check_detail_with_string(cmd_result, "may the force be with you.");
