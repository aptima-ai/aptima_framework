    ...
    if (cmd->get_name() == "hello_world_1") {
      ...
      aptima_env.send_cmd(
          ...
          [&](aptima::aptima_env_t &aptima_env, std::unique_ptr<aptima::cmd_result_t> cmd,
              aptima::error_t *err) {
            if (cmd->get_property_string("detail") == "hello world 5, too") {
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(resp_handler_basic__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(resp_handler_basic__extension_2,
                                    test_extension_2);
...
TEST(ExtensionTest, RespHandlerBasic) {  // NOLINT
  ...
  hello_world_1_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                              "resp_handler_basic__extension_group",
                              "test_extension_1");
