 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      auto *test_data = static_cast<float *>(axis_malloc(sizeof(float)));
      *test_data = TEST_DATA;
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_float_ptr__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_float_ptr__extension_2,
                                    test_extension_2);
