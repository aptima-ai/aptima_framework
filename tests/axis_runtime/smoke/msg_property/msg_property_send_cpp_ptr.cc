 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "send_ptr") {
      ...
      axis_ASSERT(*test_data->v_ == TEST_DATA, "Invalid argument.");
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_cpp_ptr__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_cpp_ptr__extension_2,
                                    test_extension_2);
