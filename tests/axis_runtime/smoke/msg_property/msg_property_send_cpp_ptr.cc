 ...
 public:
  ...
  void on_cmd(aptima::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      ...
      // _Move_ the C++ object to the APTIMA message.
 ...
 public:
  ...
  void on_cmd(aptima::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "send_ptr") {
      // Get the APTIMA message property.
      auto *test_data =
          static_cast<test_data_t *>(cmd->get_property_ptr("test data"));
      aptima_ASSERT(*test_data->v_ == TEST_DATA, "Invalid argument.");
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_cpp_ptr__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_cpp_ptr__extension_2,
                                    test_extension_2);
