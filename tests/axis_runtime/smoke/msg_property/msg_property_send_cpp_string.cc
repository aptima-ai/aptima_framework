...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_cpp_string__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_cpp_string__extension_2,
                                    test_extension_2);
