...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_c_string__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_c_string__extension_2,
                                    test_extension_2);
