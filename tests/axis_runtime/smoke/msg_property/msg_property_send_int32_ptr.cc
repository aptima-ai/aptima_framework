 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "hello_world") {
      auto *test_data = static_cast<int32_t *>(axis_malloc(sizeof(int32_t)));
      *test_data = TEST_DATA;
 ...
 public:
  ...
  void on_cmd(ten::axis_env_t &axis_env,
    ...
    if (cmd->get_name() == "send_ptr") {
      ...
      axis_ASSERT(test_data_ptr, "Invalid argument.");
      axis_ASSERT(*test_data_ptr == TEST_DATA, "Invalid argument.");

      axis_free(test_data_ptr);
...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_int32_ptr__extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_int32_ptr__extension_2,
                                    test_extension_2);
...
TEST(MsgPropertyTest, SendInt32Ptr) {  // NOLINT
  ...
  hello_world_cmd->set_dest("msgpack://127.0.0.1:8001/", nullptr,
                            "msg_property_send_int32_ptr__extension_group_1",
