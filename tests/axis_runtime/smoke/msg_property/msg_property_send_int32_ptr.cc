 ...
 public:
  ...
  void on_cmd(ten::aptima_env_t &aptima_env,
    ...
    if (cmd->get_name() == "hello_world") {
      auto *test_data = static_cast<int32_t *>(aptima_malloc(sizeof(int32_t)));
      *test_data = TEST_DATA;
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_int32_ptr__extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(msg_property_send_int32_ptr__extension_2,
                                    test_extension_2);
