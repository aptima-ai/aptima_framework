...
class test_extension_2 : public aptima::extension_t {
 public:
  ...
  void on_data(aptima::aptima_env_t &aptima_env,
    ...
    auto cmd = aptima::cmd_t::create("data_ack");
...
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(data_create_from_json__test_extension_1,
                                    test_extension_1);
aptima_CPP_REGISTER_ADDON_AS_EXTENSION(data_create_from_json__test_extension_2,
                                    test_extension_2);
