...
axis_CPP_REGISTER_ADDON_AS_EXTENSION(data_create_from_json__test_extension_1,
                                    test_extension_1);
axis_CPP_REGISTER_ADDON_AS_EXTENSION(data_create_from_json__test_extension_2,
                                    test_extension_2);
