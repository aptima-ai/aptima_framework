...
def test_send_audio_frame_go():
    ...
    source_pkg_name = "send_audio_frame_go_app"
    ...
    if sys.platform == "win32":
        ...
        if (
            ...
            libasan_path = os.path.join(
                base_path,
                "send_audio_frame_go_app/ten_packages/system/ten_runtime/lib/libasan.so",
            )
    ...
    if not is_started:
        print("The send_audio_frame_go is not started after 10 seconds.")
