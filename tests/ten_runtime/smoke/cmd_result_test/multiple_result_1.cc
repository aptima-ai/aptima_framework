 ...
 public:
  ...
  void on_cmd(aptima::ten_env_t &ten_env,
    ...
    if (cmd->get_name() == "hello_world") {
      ten_env.send_cmd_ex(
          std::move(cmd), [this](aptima::ten_env_t &ten_env,
...
class test_extension_2 : public aptima::extension_t {
 public:
  ...
  void on_cmd(aptima::ten_env_t &ten_env,
              std::unique_ptr<aptima::cmd_t> cmd) override {
    if (cmd->get_name() == "hello_world") {
      auto cmd_result_1 = aptima::cmd_result_t::create(TEN_STATUS_CODE_OK);
      ...
      auto cmd_result_2 = aptima::cmd_result_t::create(TEN_STATUS_CODE_OK);
