...
void extension_on_notify(aptima::ten_env_t &ten_env, void *user_data);
...
class test_extension : public aptima::extension_t {
 ...
 private:
  friend void extension_on_notify(aptima::ten_env_t &ten_env, void *user_data);
...
void extension_on_notify(aptima::ten_env_t &ten_env, void *user_data) {
  ...
  auto *ext = static_cast<test_extension *>(
      aptima::ten_env_internal_accessor_t::get_attached_target(ten_env));
