...
class test_extension_1 : public aptima::extension_t {
 public:
  ...
  void return_if_possible(aptima::ten_env_t &ten_env) {
...
class extension_tester_1 : public aptima::extension_tester_t {
 public:
  void on_start(aptima::ten_env_tester_t &ten_env) override {
    ...
    ten_env.send_data(aptima::data_t::create("test"));
    ten_env.send_audio_frame(aptima::audio_frame_t::create("test"));
    ten_env.send_video_frame(aptima::video_frame_t::create("test"));
