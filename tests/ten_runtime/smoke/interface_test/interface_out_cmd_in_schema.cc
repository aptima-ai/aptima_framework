 ...
 public:
  ...
  void on_cmd(aptima::ten_env_t &ten_env,
    ...
    if (cmd->get_name() == "hello_world") {
      cmd->set_property("a", "I am your father.");
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    interface_out_cmd_in_schema__test_extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    interface_out_cmd_in_schema__test_extension_2, test_extension_2);

}  // namespace

TEST(InterfaceTest, OutCmdInSchema) {  // NOLINT
  // Start app.
  auto *app_thread =
  ...
  start_graph_cmd->set_graph_from_json(R"({
           "nodes": [{
                "type": "extension",
                "name": "test_extension_1",
                "addon": "interface_out_cmd_in_schema__test_extension_1",
                "extension_group": "basic_extension_group",
                "app": "msgpack://127.0.0.1:8001/"
             },{
                "type": "extension",
                "name": "test_extension_2",
                "addon": "interface_out_cmd_in_schema__test_extension_2",
                "extension_group": "basic_extension_group",
                "app": "msgpack://127.0.0.1:8001/"
             }],
             "connections": [{
