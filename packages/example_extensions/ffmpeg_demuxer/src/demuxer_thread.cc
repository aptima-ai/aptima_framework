...
demuxer_thread_t::demuxer_thread_t(aptima::ten_env_proxy_t *ten_env_proxy,
...
void demuxer_thread_t::notify_completed(bool success) {
  ten_env_proxy_->notify([this, success](aptima::ten_env_t &ten_env) {
...
void demuxer_thread_t::send_image_eof() {
  ...
  ten_env_proxy_->notify([frame_shared](aptima::ten_env_t &ten_env) {
...
void demuxer_thread_t::reply_to_start_cmd(bool success) {
  if (!success || demuxer_ == nullptr) {
    ten_env_proxy_->notify([this](aptima::ten_env_t &ten_env) {
  ...
  auto resp = aptima::cmd_result_t::create(TEN_STATUS_CODE_OK);
  ...
  ten_env_proxy_->notify([resp_shared, this](aptima::ten_env_t &ten_env) {
