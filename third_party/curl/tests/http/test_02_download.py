...
class TestDownload:
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_02_03_download_100_sequential(
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_02_04_download_100_parallel(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_02_05_download_500_sequential(
        self, env: Env, httpd, nghttpx, repeat, proto
    ):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
    ...
    def test_02_06_download_500_parallel(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        count = 500
        max_parallel = 50
    ...
    @pytest.mark.parametrize("proto", ["h2", "h3"])
    def test_02_07_download_reuse(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        count = 200
        curl = CurlClient(env=env)
    ...
    def test_02_07b_download_reuse(self, env: Env, httpd, nghttpx, repeat, proto):
        count = 20
        curl = CurlClient(env=env)
        urln = (
            f"https://{env.authority_for(env.domain1, proto)}/data.json?[0-{count-1}]"
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_02_08_1MB_serial(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        count = 20
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_02_09_1MB_parallel(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        count = 20
        urln = f"https://{env.authority_for(env.domain1, proto)}/data-1m?[0-{count-1}]"
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_02_10_10MB_serial(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        count = 20
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_02_11_10MB_parallel(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        if proto == "h3" and env.curl_uses_lib("msh3"):
    ...
    @pytest.mark.parametrize("proto", ["h2", "h3"])
    def test_02_12_head_serial_https(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        count = 100
        urln = f"https://{env.authority_for(env.domain1, proto)}/data-10m?[0-{count-1}]"
    ...
    def test_02_13_head_serial_h2c(self, env: Env, httpd, nghttpx, repeat, proto):
        if proto == "h3" and not env.have_h3():
            pytest.skip("h3 not supported")
        count = 100
    ...
    def test_02_21_h2_lib_serial(self, env: Env, httpd, nghttpx, pause_offset, repeat):
        ...
        r = client.run(args=["-n", f"{count}", "-P", f"{pause_offset}", url])
        r.check_exit_code(0)
    ...
    def test_02_22_h2_lib_parallel_resume(
        self, env: Env, httpd, nghttpx, pause_offset, repeat
    ):
        count = 10
        max_parallel = 5
        docname = "data-10m"
    ...
    @pytest.mark.parametrize("pause_offset", [100 * 1023])
    def test_02_23_h2_lib_parallel_abort(
        self, env: Env, httpd, nghttpx, pause_offset, repeat
    ):
        count = 200
        max_parallel = 100
