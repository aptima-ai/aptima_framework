...
class TestCaddy:
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_08_02_download_1mb_sequential(self, env: Env, caddy: Caddy, repeat, proto):
        if proto == "h3" and not env.have_h3_curl():
            pytest.skip("h3 not supported in curl")
        if proto == "h3" and env.curl_uses_lib("msh3"):
            pytest.skip("msh3 itself crashes")
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_08_03_download_1mb_parallel(self, env: Env, caddy: Caddy, repeat, proto):
        if proto == "h3" and not env.have_h3_curl():
            pytest.skip("h3 not supported in curl")
        if proto == "h3" and env.curl_uses_lib("msh3"):
            pytest.skip("msh3 itself crashes")
    ...
    def test_08_04a_download_10mb_sequential(
        self, env: Env, caddy: Caddy, repeat, proto
    ):
        if proto == "h3" and not env.have_h3_curl():
            pytest.skip("h3 not supported in curl")
        if proto == "h3" and env.curl_uses_lib("msh3"):
    ...
    @pytest.mark.parametrize("proto", ["http/1.1", "h2", "h3"])
    def test_08_05_download_1mb_parallel(self, env: Env, caddy: Caddy, repeat, proto):
        if proto == "h3" and not env.have_h3_curl():
            pytest.skip("h3 not supported in curl")
        if proto == "h3" and env.curl_uses_lib("msh3"):
            pytest.skip("msh3 itself crashes")
